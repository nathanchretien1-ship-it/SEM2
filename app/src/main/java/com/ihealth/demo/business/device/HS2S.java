...
public class HS2S extends FunctionFoldActivity {
    ...
    public void initView() {
        ...
        iHealthDevicesManager.getInstance().addCallbackFilterForDeviceType(mClientCallbackId, iHealthDevicesManager.TYPE_HS2S, iHealthDevicesManager.TYPE_HS2S_PRO);
        /* Get hs2s controller */
